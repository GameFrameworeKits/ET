        ...
        private sealed class ObjectPool<T> : ObjectPoolBase, IObjectPool<T> where T : ObjectBase
        {
            ...
            public override int Capacity
            {
                ...
                set
                {
                    if (value < 0)
                    {
                        Debug.LogError("Capacity is invalid.");
                    }
            ...
            public override float ExpireTime
            {
                ...
                set
                {
                    if (value < 0f)
                    {
                        Debug.LogError("ExpireTime is invalid.");
                    }
            ...
            public void Register(T obj, bool spawned)
            {
                if (obj == null)
                {
                    Debug.LogError("Object is invalid.");
                }
            ...
            public bool CanSpawn(string name)
            {
                if (name == null)
                {
                    Debug.LogError("Name is invalid.");
                }
            ...
            public void Unspawn(object target)
            {
                ...
                {
                    Debug.LogError(string.Format("Can not find target in object pool '{0}', target type is '{1}', target value is '{2}'.", new TypeNamePair(typeof(T), Name), target.GetType().FullName, target));
                }
            }
            ...
            public void Release(int toReleaseCount, ReleaseObjectFilterCallback<T> releaseObjectFilterCallback)
            {
                ...
                {
                    Debug.LogError("Release object filter callback is invalid.");
                }
