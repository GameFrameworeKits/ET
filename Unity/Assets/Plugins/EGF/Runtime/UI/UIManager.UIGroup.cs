    ...
    internal sealed partial class UIManager : IUIManager
    {
        ...
        private sealed partial class UIGroup : IUIGroup
        {
            ...
            public void RemoveUIForm(IUIForm uiForm)
            {
                ...
                if (uiFormInfo == null)
                {
                    Debug.LogError(string.Format("Can not find UI form info for serial id '{0}', UI form asset name is '{1}'.", uiForm.SerialId, uiForm.UIFormAssetName));
                }
                ...
                {
                    Debug.LogError(string.Format("UI group '{0}' not exists specified UI form '[{1}]{2}'.", m_Name, uiForm.SerialId, uiForm.UIFormAssetName));
                }
            ...
            public void RefocusUIForm(IUIForm uiForm, object userData)
            {
                ...
                if (uiFormInfo == null)
                {
                    Debug.LogError("Can not find UI form info.");
                }
